...
export ARCH=arm
export CROSS_COMPILE=~/arm-stuff/kernel/toolchains/gcc-arm-linux-gnueabihf-4.7/bin/arm-linux-gnueabihf-
...
# Build u-boot
make distclean
make Cubietruck -j $(grep -c processor /proc/cpuinfo)
